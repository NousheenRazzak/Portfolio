...
export default function About(){
    return(
        <main className=" bg-slate-950">
          ...
          <p>Hello, I’m Nousheen. I’m a Frontend developer and WordPress developer with two immersive years of experience in the ever-evolving world of web development. But beyond the years, I’m defined by my passion for creating, my dedication to innovation, and my relentless pursuit of excellence.</p>
          <h3 className="text-yellow-500 font-bold text-3xl mt-8 mb-6">My Journey</h3>
          <p>For the past two years, I’ve delved deep into the realm of Web development. It’s been a journey of transforming ideas into tangible, functional websites. VS Code has been my canvas, and I’ve painted digital masterpieces for clients from diverse industries.</p>

          <p>But as the digital landscape advances, so does my hunger to learn and grow. While Web development remains my love, I’ve set my sights on expanding my skill set on latest technologies. My latest adventure? Becoming an AI Engineer.</p>
          <h3 className="text-yellow-500 font-bold text-3xl mt-8 mb-6">Why Choose Me</h3>
          <p><span className="text-yellow-500 font-semibold">Passion: </span>For me, web development is not just a job; it’s my passion. It’s the joy of bringing digital dreams to life, one project at a time.</p>

          <p><span className="text-yellow-500 font-semibold">Dedication: </span>Whether it’s WordPress or frontend development, I approach each project with unwavering dedication, ensuring it exceeds expectations.</p>

          <p><span className="text-yellow-500 font-semibold">Creativity: </span>My approach is fueled by creativity. I don’t just code; I design experiences that resonate.</p>

          <h3 className="text-yellow-500 font-bold text-3xl mt-8 mb-6">Join Me on This Journey</h3>
          <p>I’m on a path of continuous learning and improvement, and I’d love for you to be a part of this journey. Let’s collaborate to create digital solutions that not only meet your needs but also exceed them.</p>
