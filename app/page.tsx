    ...
    <div className="bg-slate-950 w-full">
      ...
      <div className="my-28 xl:my-64">
        ...
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="flex">
            <div className="rounded-[25px] sm:rounded-[60px] bg-yellow-400/15 p-4 sm:p-7 xl:p-14 m-2 sm:m-4">
              <h1 className="text-4xl sm:text-7xl text-yellow-500 font-bold">2+</h1>
              <p className="text-base sm:text-3xl text-white font-semibold">Years
                <br />
                Experience
              </p>
            </div>
            <div className="rounded-[25px] sm:rounded-[60px] bg-yellow-400/15 p-4 sm:p-7 xl:p-14 m-2 sm:m-4">
              <h1 className="text-4xl sm:text-7xl text-yellow-500 font-bold">10+</h1>
              <p className="text-base sm:text-3xl text-white font-semibold">Project
                <br />
                Completed
              </p>
            </div>
        ...
        <div className="rounded-[25px] sm:rounded-[60px] bg-zinc-900 text-white p-6 sm:p-10 my-10 text-base sm:text-xl">
      ...
      <div className="flex flex-col lg:flex-row gap-3">
        <div className="bg-gradient-to-l from-gray-500 via-gray-400 to-gray-300 p-3 sm:p-10 lg:p-7 xl:p-10 w-full lg:w-2/4 sm:m-3 rounded-[40px] sm:rounded-[60px]">
          <div className="flex sm:flex-row justify-between mb-8">
            <div className="rounded-full bg-black flex px-3 sm:px-6 py-2 items-center">
              <Image src={Calender} width={30} alt="Calender" className="max-sm:w-5"/>
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-yellow-500 pl-3">2013</p>
            </div>
            <div className="rounded-full bg-white flex px-3 sm:px-6 py-2 items-center">
              <Image src={Graduation} width={40} alt="Graduation cap" className="max-sm:w-7"/>
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black pl-3">Intermediate</p>
            </div>
          </div>
          <div className="flex sm:flex-row">
            <div className="rounded-full bg-white flex px-4 sm:px-6 py-2 items-center mb-5 mx-1">
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black">Intermediate</p>
            </div>
            <div className="rounded-full bg-white flex px-4 sm:px-6 py-2 items-center mb-5 mx-1">
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black">Commerce</p>
            </div>
          </div>
          <h3 className="text-xl sm:text-3xl lg:text-2xl xl:text-3xl font-bold text-start">Intermediate in Commerce</h3>
          <div>
            <div className="flex my-2">
              ...
              <div className="px-3 sm:px-6 py-2 flex items-center">
                <p className="text-sm sm:text-xl lg:text-lg xl:text-xl font-medium text-black">Govt. Commerce College</p>
              </div>
            </div>
            <div className="flex my-2">
            <div className="rounded-full bg-white flex p-3 sm:p-5 items-center">
            <Image src={City} width={20} alt="Location"/>
              ...
              <div className="px-3 sm:px-6 py-2 flex items-center">
                <p className="text-sm sm:text-xl lg:text-lg xl:text-xl font-medium text-black">Karachi</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-l from-gray-500 via-gray-400 to-gray-300 p-3 sm:p-10 lg:p-7 xl:p-10 w-full lg:w-2/4 sm:m-3 rounded-[40px] sm:rounded-[60px]">
          <div className="flex justify-between mb-8">
            <div className="rounded-full bg-black flex px-3 sm:px-6 py-2 items-center">
              <Image src={Calender} width={30} alt="Calender" className="max-sm:w-5"/>
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-yellow-500 pl-3">2016</p>
            </div>
            <div className="rounded-full bg-white flex px-3 sm:px-6 py-2 items-center">
              <Image src={Graduation} width={40} alt="Graduation cap" className="max-sm:w-5"/>
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black pl-3">Graduation</p>
            </div>
          </div>
            <div className="flex">
            <div className="rounded-full bg-white flex px-4 sm:px-6 py-2 items-center mb-5 mx-1">
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black">Bachelor Degree</p>
            </div>
            <div className="rounded-full bg-white flex px-4 sm:px-6 py-2 items-center mb-5 mx-1">
              <p className="text-sm sm:text-2xl lg:text-xl xl:text-2xl font-bold text-black">B.com</p>
            </div>
            </div>
          <h3 className="text-xl sm:text-3xl lg:text-2xl xl:text-3xl font-bold text-start">Bachelors in Commerce</h3>
          <div>
            <div className="flex my-2">
              <div className="rounded-full bg-white flex p-3 sm:p-5 items-center">
              <Image src={College} width={20} alt="College"/>
      ...
      <h1 className="text-center text-yellow-400 text-4xl sm:text-5xl font-bold my-14">Projects I have Worked on</h1>
        <div className="bg-[#102762] p-5 sm:p-10 m-3 rounded-[30px] sm:rounded-[40px] xl:rounded-[60px] flex flex-col lg:flex-row gap-5">
          <div className="w-full xl:w-1/2 bg-[#405281] rounded-[20px] sm:rounded-[30px] xl:rounded-[60px] flex justify-center overflow-hidden">
          ...
          <div className="w-3/5 sm:w-2/4 xl:w-1/4 rounded-full bg-[#405281] p-2 my-2">
        <p className="text-sm sm:text-base text-white font-bold text-center">Landing Page</p>
        </div>
       ...
       <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2 max-lg:p-1 max-lg:m-1">
        <Image src={Figma} width={30} alt="Figma" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold">Figma</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2 max-lg:p-1 max-lg:m-1">
        <Image src={VSCode} width={30} alt="VS Code" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold">VS Code</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2 max-lg:p-1 max-lg:m-1">
        <Image src={JavaScript} width={30} alt="Javascript" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">JavaScript</p>
        </div>
      </div>
      ...
      <div className="flex justify-start flex-wrap sm:flex-nowrap lg:flex-wrap">
        ...
        <Image src={NextJS} width={30} alt="NextJS" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">NextJS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Tailwind} width={30} alt="Tailwind CSS" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Tailwind CSS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Github} width={30} alt="Github" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Github</p>
        </div>
      </div>
          <button className="rounded-full border-2 bg-[#405281] border-white py-4 px-6 text-sm sm:text-xl font-bold text-white mt-5 flex justify-start"><a href="https://positivus-landing-page-p29.vercel.app/" target="_blank" className="flex"><Image src={Linking} width={40} alt="Linking" className="pr-2 max-sm:w-5"/>View Landing Page</a></button>
          </div>
          </div>
        </div>

        <div className="bg-[#3f031b] p-5 sm:p-10 m-3 rounded-[30px] sm:rounded-[40px] xl:rounded-[60px] flex flex-col lg:flex-row gap-5">
          <div className="w-full xl:w-1/2 bg-[#653549] rounded-[20px] sm:rounded-[30px] xl:rounded-[60px] flex justify-center overflow-hidden">
        ...
        <p className="text-sm sm:text-base text-white font-bold text-center">Website</p>
        </div>
          <p className="text-start text-base sm:text-lg font-semibold text-white my-2">Technologies I have Used</p>
          <div className="flex justify-start flex-wrap sm:flex-nowrap">
       <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        ...
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={JavaScript} width={30} alt="Javascript" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold">JavaScript</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Typescript} width={30} alt="Typescript" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">TypeScript</p>
        </div>
      </div>
      ...
      <div className="flex justify-start flex-wrap sm:flex-nowrap lg:flex-wrap">
        ...
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Css} width={30} alt="Tailwind CSS" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Custom CSS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Github} width={30} alt="Github" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Github</p>
          ...
          <button className="rounded-full border-2 bg-[#653549] border-white py-4 px-6 text-sm sm:text-xl font-bold text-white mt-5 flex justify-start"><a href="#" className="flex"><Image src={Linking} width={40} alt="Linking" className="pr-2 max-sm:w-7"/>View Website</a></button>
          </div>
          </div>
        </div>

        <div className="bg-[#830332] p-5 sm:p-10 m-3 rounded-[30px] sm:rounded-[40px] xl:rounded-[60px] flex flex-col lg:flex-row gap-5">
          <div className="w-full xl:w-1/2 bg-[#9c355b] rounded-[20px] sm:rounded-[30px] xl:rounded-[60px] flex justify-center overflow-hidden">
        ...
        <p className="text-sm sm:text-base text-white font-bold text-center">Portfolio</p>
        </div>
          <p className="text-start text-base sm:text-lg font-semibold text-white my-2">Technologies I have Used</p>
          <div className="flex justify-start flex-wrap sm:flex-nowrap">
       <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Wordpress} width={30} alt="Wordpress" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold">WordPress</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Elementor} width={30} alt="Elementor" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold">Elementor</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Theme} width={30} alt="Theme" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Theme</p>
        </div>
      </div>
          
      <div className="flex justify-start flex-wrap sm:flex-nowrap">
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Caching} width={30} alt="Plugins" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Plugins</p>
        </div>
        <div className="rounded-full bg-white flex justify-between items-center p-1 m-1 sm:p-2 sm:m-2">
        <Image src={Hosting} width={30} alt="Hosting" className="max-sm:w-5"/>
        <p className="text-sm sm:text-base font-bold pl-2">Hosting</p>
        </div>
      </div>
          <button className="rounded-full border-2 bg-[#9c355b] border-white py-4 px-6 text-sm sm:text-xl font-bold text-white mt-5 flex justify-start"><a href="https://iamnousheen.com/" target="_blank" className="flex"><Image src={Linking} width={40} alt="Linking" className="pr-2 max-sm:w-7"/>View Portfolio</a></button>
          </div>
        </div>
          </div>
      </div>
      ...
      <div className="flex justify-center flex-wrap lg:flex-nowrap gap-2 max-sm:my-2">
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Html} width={40} alt="HTML" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">HTML</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Css} width={40} alt="CSS" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">CSS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={ReactJS} width={40} alt="ReactJS" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">React JS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={JavaScript} width={40} alt="JavaScript" className="max-sm:w-7"/>
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center gap-2 max-sm:my-2">
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={NextJS} width={40} alt="NextJS" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">NextJS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Tailwind} width={40} alt="Tailwind CSS" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">Tailwind CSS</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Bootstrap} width={40} alt="Bootstrap" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">Bootstrap</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Git} width={40} alt="Git" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">Git</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-3 xl:p-7 items-center sm:m-2">
        <Image src={Github} width={40} alt="Github" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold pl-2">Github</p>
        </div>
      </div>

      <div className="flex justify-center flex-wrap lg:flex-nowrap gap-2 max-sm:my-2">
       <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-4 xl:p-7 items-center sm:m-2">
        <Image src={Figma} width={40} alt="Figma" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold">Figma</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-4 xl:p-7 items-center sm:m-2">
        <Image src={Typescript} width={40} alt="Typescript" className="max-sm:w-7"/>
        <p className="text-base sm:text-2xl lg:text-lg xl:text-2xl font-bold">TypeScript</p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-2 sm:p-7 lg:p-4 xl:p-7 items-center sm:m-2">
        <Image src={Vercel} width={30} alt="Vercel" className="max-sm:w-7"/>
      ...
      <div className="rounded-[30px] sm:rounded-[60px] bg-zinc-900 text-white p-6 sm:p-10 my-10 text-xl">
      ...
      <div className="flex max-sm:flex-wrap max-sm:items-center justify-center max-sm:w-full gap-2">
        ...
        <Image src={Facebook} width={40} alt="Facebook" className="max-sm:w-5"/>
        <p className="text-base sm:text-2xl font-bold pl-2"><a href="#" target="_blank">Facebook</a></p>
        </div>
        <div className="rounded-full bg-white flex justify-between p-3 sm:p-7 items-center sm:m-2">
        <Image src={LinkedIn} width={40} alt="Linkedin" className="max-sm:w-5"/>
        ...
        <div className="rounded-full bg-white flex justify-between p-3 sm:p-7 items-center sm:m-2">
        <Image src={Twitter} width={40} alt="Twitter" className="max-sm:w-5"/>
      ...
      <div className="flex justify-center">
        ...
        <Image src={Gmail} width={40} alt="Email" className="max-sm:w-5"/>
        <p className="text-base sm:text-2xl font-bold pl-2">hello@iamnousheen.com</p>
        </div>
      </div>

      <div className="flex justify-center mt-10">
        <Image src={Girl} width={250} alt="Girl Image"  className="max-sm:w-40"/>
      </div>
      </div>
